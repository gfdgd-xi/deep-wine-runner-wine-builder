...
sudo debootstrap --arch=ppc64el buster debian10-ppc64el
...
sudo pardus-chroot debian10-ppc64el
sudo pardus-chroot ubuntu20.04-riscv64
sudo aria2c -d debian10-ppc64el -o build.sh https://github.com/gfdgd-xi/auto-building-wine/raw/main/build-box86-in-chroot.sh
...
sudo chroot debian10-ppc64el bash /build.sh $box64url
...
cp debian10-ppc64el/box/*.deb /tmp/result/box64_${box64version}_ppc64el.deb -rv
cp debian10-ppc64el/box/*.deb /tmp/result/box64_ppc64el.deb -rv
